  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
      <div class="wrap-login100">
        ...
        <a href="profile.php" style="color: black; text-decoration: underline;" >Go back to profile</a>
...
if (isset($_POST['wallet'])) {
	...
	$u=$_SESSION['userid'];
  $updated=$_SESSION['updated_value'];
...
$result=mysqli_query($db,$sql1);
 ...
 $_SESSION['bal']=$row['balance'];
		...
		echo '<script type="text/javascript">
          ...
          window.onload = function () { alert("Payment successfull"); }


</script>';

 $sql1="UPDATE travels set seats='$updated' where name='$t'";
